...
if __name__ == '__main__':
    ...
    smtdata = (smtlib2_string_from_file('define-fun goal () Bool', sys.argv[1], sys.argv[2] if len(sys.argv) > 2 else "1")
               + '\n(assert (not goal))')
    ...
    try:
        ...
        print('VALID' if final_result == 'UNSAT' else final_result)
